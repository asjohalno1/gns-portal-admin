      ...
      <div className="grid lg:grid-cols-2 gap-5 mt-7">
        <div className="border border-customGray p-5 rounded-[20px]">
          ...
          <div className="divide-y divide-gray-100 h-[250px] overflow-y-scroll">
            <div className="px-4 py-1 mb-2 hover:bg-gray-50 transition-colors border-b-[1px] border-customGray duration-200 cursor-pointer group">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-[14px] font-regular text-body mt-1">
                        Tech Solutions - Annual report due
                      </p>
                    </div>
