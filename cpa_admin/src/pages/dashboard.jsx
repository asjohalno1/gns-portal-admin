...
const Dashboard = () => {
  ...
  const [documentCompletionValue, setDocumentCompletionValue] = useState([]);
      ...
      <div className="p-7.5 pt-[86px]">
        ...
        <div className="grid lg:grid-cols-2 gap-5 mt-7">
          <div className="border border-customGray p-5 rounded-[20px]">
            <h4 className="text-[#2C3E50] font-semibold text-lg mb-5">
              Recent Activity
            </h4>
            <ul className="grid grid-cols-2 gap-5">
              {documentCompletionValue?.map((item, index) => {
                const bgColor =
                  {
                    individual: "#E4F3EB",
                    "Business tax": "#F3EDE4",
                    others: "#E4F0F3",
                  }[item.category.toLowerCase()] || "#F3E4E4";
                ...
                const barColor =
                  {
                    ...
                    "Business tax": "#FDA830",
                    others: "#497FFF",
                  }[item.category.toLowerCase()] || "#F94853";
                ...
                return (
                  ...
                  >
                    <h4 className="text-[#2C3E50] mb-1 text-lg font-semibold">
                      {item.percentage}%
                    </h4>
                    <p className="text-[#2c3e50] text-sm font-normal mb-2.5">
                      {item.category}
                    </p>
                    <div className="h-2.5 w-full bg-white rounded-[20px] relative">
                      <span
                        className="h-2.5 absolute rounded-tl-[20px] rounded-bl-[20px]"
                        style={{
          ...
          <div className="border border-customGray p-5 rounded-[20px]">
            ...
            <ul className="overflow-y-auto h-[225px]">
              {["overdue", "today", "tomorrow"].map((category) => {
                const tasks = urgentTasks[category] || [];
                const labelColor = {
                  overdue: "#F94853",
                  today: "#F94853",
                  tomorrow: "#FDA830",
                ...
                return tasks.map((task, idx) => (
                  ...
                  >
                    ...
                    <p className="text-[#2C3E50] font-normal text-sm">
