...
// import ClientTablelinks from "../../Component/clienttablelinks/clienttablelinks";
// import DocumentRequestModal from "./DocumentRequestModalClient";
// import SecureLinksendsuccessfullyModal from "./SecurelinksendModal";
// import UploadSecurelinkModal from "./Uploadsecurelink";
// import Choosereqtemplate from "./chooserequesttemplatemodal";
// import RequestdocModal from "./requestdocumentmodal";
// import Sendremindermodal from "./Sendreminder";
// import DocumentModal from "./Documentrequestmodal";
...
const ClientManagement = () => {
  ...
  return (
    <div
      className={`min-h-screen   md:ml-auto w-[82%] ${
        open ? "82%" : "close-sidebar w-[100%]"
      }`}
    >
      {/* <Header toggleButton={toggleButton} /> */}
        <div className="p-7.5 pt-[86px]">
          <div className="flex border-b border-gray-300 space-x-4 mb-[30px]">
            <button
              className={`px-5 py-[7px] font-semibold text-base leading-[100%] tracking-[0] rounded-t-md ${
                activeTab === "tab1"
